...
SECRET_KEY = 'django-insecure-2t$n9j#0ypbke-czt-625l)y1evpdnxe=)y$%x0a1@l#4^elg1'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'jane.pythonanywhere.com']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'hangarin', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
